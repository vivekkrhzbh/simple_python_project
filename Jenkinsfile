pipeline {
    ...
    stages {
        stage('Checkout') { // Stage to checkout the code
            steps {
                git url: 'https://github.com/vivekkrhzbh/simple_python_project.git', branch: 'master' // For local git repo. For remote: 'https://github.com/your_username/my_python_app.git'
